...
BASE_CLASSES = [
    ...
    "focus:group-[.errors]:ring-red-200",
    "dark:bg-base-900",
    ...
    "dark:focus:group-[.errors]:ring-red-600/40",
]
...
FILE_CLASSES = [
    ...
    "focus-within:ring-3",
    "group-[.errors]:border-red-600",
    "focus-within:group-[.errors]:ring-red-200",
    ...
    "dark:group-[.errors]:border-red-500",
    "dark:focus-within:group-[.errors]:ring-red-600/40",
]
